        ...
        Item {
            ...
            PlasmaWidgets.Slider {
                ...
                onValueChanged: {
                    ...
                    if(level == 0)
                        soundicon.setIcon("audio-volume-muted");
                    else if(level < 34)
                        soundicon.setIcon("audio-volume-low");
                    else if(level< 70)
                        soundicon.setIcon("audio-volume-medium");
                    else if (level<=100)
                        soundicon.setIcon("audio-volume-high");
                }
            }
        }
